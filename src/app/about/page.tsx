  ...
  return (
    <div className="aboutContainer">
      ...
      <section className="section">
        <h2>Our Vision</h2>
        <p>
          At Dreamy Cakes, we envision a world where cake isn&apos;t just a dessert
          but a beautiful work of art that makes moments special. Our goal is to
          continue innovating, expanding our reach, and ensuring that everyone
          who tastes our cakes experiences the love and care that goes into
          every bite.
        </p>
      </section>
      ...
      <section className="section">
        <h2>Get In Touch</h2>
        <p>
          If you&apos;d like to learn more about our cakes or make an order, feel
          free to contact us:
        </p>
